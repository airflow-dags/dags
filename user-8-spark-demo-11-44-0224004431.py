...
args = {
    "project_id": "user-8-spark-demo-11-44-0224004431",
}

dag = DAG(
    "user-8-spark-demo-11-44-0224004431",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user-8-spark-demo-11-44.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user-8-spark-demo-11-44-0224004431",
