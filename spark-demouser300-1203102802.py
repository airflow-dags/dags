...
args = {
    "project_id": "spark-demouser300-1203102802",
}

dag = DAG(
    "spark-demouser300-1203102802",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demouser300.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demouser300-1203102802",
