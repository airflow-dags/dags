...
args = {
    "project_id": "opentlc-mgr-0422-deploy-model-0422070104",
}

dag = DAG(
    "opentlc-mgr-0422-deploy-model-0422070104",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-0422-deploy-model.pipeline.",
...
notebook_op_4464fe94_a958_4cb2_b8b8_b080f87ff679 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0422-deploy-model-0422070104",
