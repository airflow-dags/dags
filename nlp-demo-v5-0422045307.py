...
args = {
    "project_id": "nlp-demo-v5-0422045307",
}

dag = DAG(
    "nlp-demo-v5-0422045307",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using nlp-demo-v5.pipeline.",
...
notebook_op_4464fe94_a958_4cb2_b8b8_b080f87ff679 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="nlp-demo-v5-0422045307",
