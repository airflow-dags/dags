...
args = {
    "project_id": "user2-spark-demo-3-1114071519",
}

dag = DAG(
    "user2-spark-demo-3-1114071519",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user2-spark-demo-3.pipeline.",
