...
args = {
    "project_id": "tom-spark-demo-0214053326",
}

dag = DAG(
    "tom-spark-demo-0214053326",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tom-spark-demo.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tom-spark-demo-0214053326",
