...
args = {
    "project_id": "0427-02-deploy-NLP-model-0427041839",
}

dag = DAG(
    "0427-02-deploy-NLP-model-0427041839",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0427-02-deploy-NLP-model.pipeline.",
...
notebook_op_4464fe94_a958_4cb2_b8b8_b080f87ff679 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0427-02-deploy-NLP-model-0427041839",
