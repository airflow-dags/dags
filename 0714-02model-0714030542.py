...
args = {
    "project_id": "0714-02model-0714030542",
}

dag = DAG(
    "0714-02model-0714030542",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0714-02model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0714-02model-0714030542",
