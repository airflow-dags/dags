...
args = {
    "project_id": "nlpdemov3-0422042511",
}

dag = DAG(
    "nlpdemov3-0422042511",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using nlpdemov3.pipeline.",
...
notebook_op_4464fe94_a958_4cb2_b8b8_b080f87ff679 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="nlpdemov3-0422042511",
