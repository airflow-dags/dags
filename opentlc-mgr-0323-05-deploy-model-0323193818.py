...
args = {
    "project_id": "opentlc-mgr-0323-05-deploy-model-0323193818",
}

dag = DAG(
    "opentlc-mgr-0323-05-deploy-model-0323193818",
    default_args=args,
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0323-05-deploy-model-0323193818",
