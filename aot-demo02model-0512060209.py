...
args = {
    "project_id": "aot-demo02model-0512060209",
}

dag = DAG(
    "aot-demo02model-0512060209",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using aot-demo02model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="aot-demo02model-0512060209",
