...
args = {
    "project_id": "user5-deploy-model-20221114.1-1114081103",
}

dag = DAG(
    "user5-deploy-model-20221114.1-1114081103",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user5-deploy-model-20221114.1.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user5-deploy-model-20221114.1-1114081103",
