...
args = {
    "project_id": "tom-deploy_model-2-0214061556",
}

dag = DAG(
    "tom-deploy_model-2-0214061556",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tom-deploy_model-2.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tom-deploy_model-2-0214061556",
