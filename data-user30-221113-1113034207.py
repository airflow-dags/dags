...
args = {
    "project_id": "data-user30-221113-1113034207",
}

dag = DAG(
    "data-user30-221113-1113034207",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using data-user30-221113.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="data-user30-221113-1113034207",
