...
args = {
    "project_id": "spark-demo_take_2-0203013613",
}

dag = DAG(
    "spark-demo_take_2-0203013613",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using spark-demo_take_2.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="spark-demo_take_2-0203013613",
