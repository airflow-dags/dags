...
args = {
    "project_id": "Tom-model-depoy-4-0214065720",
}

dag = DAG(
    "Tom-model-depoy-4-0214065720",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using Tom-model-depoy-4.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="Tom-model-depoy-4-0214065720",
