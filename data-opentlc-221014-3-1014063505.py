...
args = {
    "project_id": "data-opentlc-221014-3-1014063505",
}

dag = DAG(
    "data-opentlc-221014-3-1014063505",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using data-opentlc-221014-3.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="data-opentlc-221014-3-1014063505",
