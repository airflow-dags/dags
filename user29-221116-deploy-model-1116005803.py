...
args = {
    "project_id": "user29-221116-deploy-model-1116005803",
}

dag = DAG(
    "user29-221116-deploy-model-1116005803",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user29-221116-deploy-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user29-221116-deploy-model-1116005803",
