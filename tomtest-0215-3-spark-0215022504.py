...
args = {
    "project_id": "tomtest-0215-3-spark-0215022504",
}

dag = DAG(
    "tomtest-0215-3-spark-0215022504",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tomtest-0215-3-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tomtest-0215-3-spark-0215022504",
