...
dag = DAG(
    ...
    description="Created with Elyra 2.2.4 pipeline editor using rc-01.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="rc-01-0803032328",
