...
args = {
    "project_id": "model-opentlc-220829-0829100857",
}

dag = DAG(
    "model-opentlc-220829-0829100857",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using model-opentlc-220829.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="model-opentlc-220829-0829100857",
