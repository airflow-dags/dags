...
args = {
    "project_id": "user3-0928-01-MLFlow-0928030226",
}

dag = DAG(
    "user3-0928-01-MLFlow-0928030226",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user3-0928-01-MLFlow.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user3-0928-01-MLFlow-0928030226",
