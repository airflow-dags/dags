...
args = {
    "project_id": "user29-0320-01-spark-0319234655",
}

dag = DAG(
    "user29-0320-01-spark-0319234655",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user29-0320-01-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user29-0320-01-spark-0319234655",
