...
args = {
    "project_id": "deploy_model-u29-2-1114081936",
}

dag = DAG(
    "deploy_model-u29-2-1114081936",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using deploy_model-u29-2.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="deploy_model-u29-2-1114081936",
