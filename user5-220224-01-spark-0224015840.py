...
args = {
    "project_id": "user5-220224-01-spark-0224015840",
}

dag = DAG(
    "user5-220224-01-spark-0224015840",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user5-220224-01-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user5-220224-01-spark-0224015840",
...
notebook_op_91a3738b_783b_4eb6_823c_1b8b013a4d51 = NotebookOp(
    ...
    image="quat.io/ml-aml-workshop/elyra-spark:0.0.4",
    in_cluster=True,
    env_vars={
        "AWS_ACCESS_KEY_ID": "minio",
        "AWS_SECRET_ACCESS_KEY": "minio123",
