...
args = {
    "project_id": "u29-0525-01-0524233340",
}

dag = DAG(
    "u29-0525-01-0524233340",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using u29-0525-01.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="u29-0525-01-0524233340",
