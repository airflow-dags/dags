...
args = {
    "project_id": "test-fm-new-0111142512",
}

dag = DAG(
    "test-fm-new-0111142512",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using test-fm-new.pipeline.",
...
notebook_op_05b9ddfb_efc7_4c37_843b_8bcdc8f6e0a9 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="test-fm-new-0111142512",
