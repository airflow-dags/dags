...
args = {
    "project_id": "0615-05-spark-0615070146",
}

dag = DAG(
    "0615-05-spark-0615070146",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0615-05-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0615-05-spark-0615070146",
