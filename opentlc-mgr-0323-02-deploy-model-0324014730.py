...
args = {
    "project_id": "opentlc-mgr-0323-02-deploy-model-0324014730",
}

dag = DAG(
    "opentlc-mgr-0323-02-deploy-model-0324014730",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-0323-02-deploy-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0323-02-deploy-model-0324014730",
