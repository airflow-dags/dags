...
args = {
    "project_id": "flights-pipeline-2-0313084527",
}

dag = DAG(
    "flights-pipeline-2-0313084527",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-pipeline-2.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-pipeline-2-0313084527",
...
notebook_op_85b1962c_e91c_4a01_b2e6_94ea6c2f8c6c = NotebookOp(
    name="clean_data",
    namespace="ml-workshop",
    task_id="clean_data",
    notebook="Machine-Learning-on-Kubernetes/chapter9/clean_data.ipynb",
    cos_endpoint="http://minio-ml-workshop:9000",
    cos_bucket="airflow",
    cos_directory="flights-pipeline-2-0313084527",
    cos_dependencies_archive="clean_data-85b1962c-e91c-4a01-b2e6-94ea6c2f8c6c.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=["spark-info.txt"],
    image="quay.io/ml-on-k8s/elyra-spark:0.0.4",
    in_cluster=True,
...
notebook_op_85b1962c_e91c_4a01_b2e6_94ea6c2f8c6c.image_pull_policy = "IfNotPresent"

(
    notebook_op_85b1962c_e91c_4a01_b2e6_94ea6c2f8c6c
    << notebook_op_5ad53c7e_c1a5_4dab_b766_cd6e3642891a
)
