...
args = {
    "project_id": "test-deploy-fm-0112011341",
}

dag = DAG(
    "test-deploy-fm-0112011341",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using test-deploy-fm.pipeline.",
...
notebook_op_1c890a68_7ca6_477d_8d88_56acbaee7a17 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="test-deploy-fm-0112011341",
