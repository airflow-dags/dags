...
args = {
    "project_id": "model-user10-221108-1109025829",
}

dag = DAG(
    "model-user10-221108-1109025829",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using model-user10-221108.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="model-user10-221108-1109025829",
