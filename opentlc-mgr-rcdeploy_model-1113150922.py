...
args = {
    "project_id": "opentlc-mgr-rcdeploy_model-1113150922",
}

dag = DAG(
    "opentlc-mgr-rcdeploy_model-1113150922",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-rcdeploy_model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-rcdeploy_model-1113150922",
