...
args = {
    "project_id": "tom-12-14-1214003607",
}

dag = DAG(
    "tom-12-14-1214003607",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tom-12-14.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tom-12-14-1214003607",
