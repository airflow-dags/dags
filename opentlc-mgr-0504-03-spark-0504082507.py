...
args = {
    "project_id": "opentlc-mgr-0504-03-spark-0504082507",
}

dag = DAG(
    "opentlc-mgr-0504-03-spark-0504082507",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-0504-03-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0504-03-spark-0504082507",
...
notebook_op_91a3738b_783b_4eb6_823c_1b8b013a4d51 = NotebookOp(
    ...
    env_vars={
        ...
        "AWS_SECRET_ACCESS_KEY": "minio123",
        "ELYRA_ENABLE_PIPELINE_INFO": "True",
        "SPARK_CLUSTER": "opentlc-mgr-cluste",
        "WORKER_NODES": "2",
        "S3_ENDPOINT_URL": "http://minio-ml-workshop:9000",
    },
    config_file="None",
