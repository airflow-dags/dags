...
args = {
    "project_id": "model-user30-221113-1113035212",
}

dag = DAG(
    "model-user30-221113-1113035212",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using model-user30-221113.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="model-user30-221113-1113035212",
