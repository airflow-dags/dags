...
args = {
    "project_id": "opentlc-mgr-0413-02-spark-0413053336",
}

dag = DAG(
    "opentlc-mgr-0413-02-spark-0413053336",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-0413-02-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0413-02-spark-0413053336",
