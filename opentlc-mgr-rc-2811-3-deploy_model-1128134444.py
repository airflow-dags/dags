...
args = {
    "project_id": "opentlc-mgr-rc-2811-3-deploy_model-1128134444",
}

dag = DAG(
    "opentlc-mgr-rc-2811-3-deploy_model-1128134444",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-rc-2811-3-deploy_model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-rc-2811-3-deploy_model-1128134444",
