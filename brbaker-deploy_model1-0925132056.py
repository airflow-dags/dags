...
args = {
    "project_id": "brbaker-deploy_model1-0925132056",
}

dag = DAG(
    "brbaker-deploy_model1-0925132056",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using brbaker-deploy_model1.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="brbaker-deploy_model1-0925132056",
