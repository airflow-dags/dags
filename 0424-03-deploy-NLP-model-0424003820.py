...
args = {
    "project_id": "0424-03-deploy-NLP-model-0424003820",
}

dag = DAG(
    "0424-03-deploy-NLP-model-0424003820",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0424-03-deploy-NLP-model.pipeline.",
...
notebook_op_4464fe94_a958_4cb2_b8b8_b080f87ff679 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0424-03-deploy-NLP-model-0424003820",
