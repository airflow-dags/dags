...
args = {
    "project_id": "user10-0928-1-deploy-model-0928031650",
}

dag = DAG(
    "user10-0928-1-deploy-model-0928031650",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user10-0928-1-deploy-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user10-0928-1-deploy-model-0928031650",
