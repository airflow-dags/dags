...
args = {
    "project_id": "opentlc-mgr-0412-01-spark-0412042312",
}

dag = DAG(
    "opentlc-mgr-0412-01-spark-0412042312",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using opentlc-mgr-0412-01-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    notebook="ml-workshop/src/airflow/deploy_spark_jobs/start-spark-cluster.py",
    cos_endpoint="http://minio-ml-workshop:9000",
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0412-01-spark-0412042312",
...
notebook_op_b6d6a9d3_65b6_4ef6_9ce8_4d713bea5e2f = NotebookOp(
    ...
    notebook="ml-workshop/src/airflow/deploy_spark_jobs/stop-spark-cluster.py",
    cos_endpoint="http://minio-ml-workshop:9000",
    cos_bucket="airflow",
    cos_directory="opentlc-mgr-0412-01-spark-0412042312",
