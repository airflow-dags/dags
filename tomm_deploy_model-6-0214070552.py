...
args = {
    "project_id": "tomm_deploy_model-6-0214070552",
}

dag = DAG(
    "tomm_deploy_model-6-0214070552",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tomm_deploy_model-6.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tomm_deploy_model-6-0214070552",
