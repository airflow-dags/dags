...
args = {
    "project_id": "jhuser-0621-04-deploy_model-0621221647",
}

dag = DAG(
    "jhuser-0621-04-deploy_model-0621221647",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using jhuser-0621-04-deploy_model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="jhuser-0621-04-deploy_model-0621221647",
