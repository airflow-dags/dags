...
args = {
    "project_id": "flights-model-deploy-0329024744",
}

dag = DAG(
    "flights-model-deploy-0329024744",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-model-deploy.pipeline.",
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-deploy-0329024744",
    ...
    env_vars={
        ...
        "MODEL_NAME": "flghts-ontime-classification",
        "MODEL_VERSION": "1",
