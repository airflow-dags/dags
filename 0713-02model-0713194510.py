...
args = {
    "project_id": "0713-02model-0713194510",
}

dag = DAG(
    "0713-02model-0713194510",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0713-02model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0713-02model-0713194510",
