...
args = {
    "project_id": "test-fmv2-0112021159",
}

dag = DAG(
    "test-fmv2-0112021159",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using test-fmv2.pipeline.",
...
notebook_op_05b9ddfb_efc7_4c37_843b_8bcdc8f6e0a9 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="test-fmv2-0112021159",
