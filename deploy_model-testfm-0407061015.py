...
args = {
    "project_id": "deploy_model-testfm-0407061015",
}

dag = DAG(
    "deploy_model-testfm-0407061015",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using deploy_model-testfm.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="deploy_model-testfm-0407061015",
