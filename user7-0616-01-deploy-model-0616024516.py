...
args = {
    "project_id": "user7-0616-01-deploy-model-0616024516",
}

dag = DAG(
    "user7-0616-01-deploy-model-0616024516",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user7-0616-01-deploy-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user7-0616-01-deploy-model-0616024516",
