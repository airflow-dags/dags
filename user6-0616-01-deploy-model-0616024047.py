...
args = {
    "project_id": "user6-0616-01-deploy-model-0616024047",
}

dag = DAG(
    "user6-0616-01-deploy-model-0616024047",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user6-0616-01-deploy-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="user6-0616-01-deploy-model-0616024047",
