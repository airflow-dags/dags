...
args = {
    "project_id": "fm-aot-user25-model-0511074644",
}

dag = DAG(
    "fm-aot-user25-model-0511074644",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using fm-aot-user25-model.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="fm-aot-user25-model-0511074644",
