...
args = {
    "project_id": "flights-model-t10-0331111924",
}

dag = DAG(
    "flights-model-t10-0331111924",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-model-t10.pipeline.",
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-t10-0331111924",
