...
args = {
    "project_id": "tom_deploy_model_1-0214060607",
}

dag = DAG(
    "tom_deploy_model_1-0214060607",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using tom_deploy_model_1.pipeline.",
...
notebook_op_9717753b_c990_4c21_88ba_4a46474a32e4 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="tom_deploy_model_1-0214060607",
