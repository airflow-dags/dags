...
args = {
    "project_id": "0526-01-spark-0526015119",
}

dag = DAG(
    "0526-01-spark-0526015119",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using 0526-01-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="0526-01-spark-0526015119",
