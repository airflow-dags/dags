...
args = {
    "project_id": "user18-0222-10-spark-0224030049",
}

dag = DAG(
    "user18-0222-10-spark-0224030049",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using user18-0222-10-spark.pipeline.",
...
notebook_op_d5009697_771e_4f71_bc20_e52d905c9f9d = NotebookOp(
    ...
    cos_bucket="aitflow",
    cos_directory="user18-0222-10-spark-0224030049",
